...
### `resolve(key_code: KeyCode) -> Option<String>`

Resolves a `KeyCode` to its localized name according to the current keyboard layout. Useful for displaying hotkey labels to the user in the correct script.
