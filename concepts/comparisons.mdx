---
title: "Comparisons: Benchmarks for Speedrun Splits"
sidebarTitle: "Comparisons"
description: "livesplit-core provides built-in comparison generators—Best Segments, Balanced PB, Average Segments, and more—to benchmark your current run against historical data."
---
