---
title: "Timer: Control Speedrun Attempts in livesplit-core"
sidebarTitle: "Timer"
description: "Timer wraps a Run and exposes all controls for speedrun attempts: start, split, pause, reset, and game time. Covers TimerPhase and timing methods."
---
